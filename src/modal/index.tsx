            ...
            {Array.isArray(manage) && manage.length > 0 ? (
              <>
                ...
                >
                  {isNone
                    ? manage
                        ?.filter((item) => !item.todayLastLogs[item.todayLastLogs.length - 1].isExist)
                        .map((item, idx) => (
                  ...
                  {isNone
                    ? manage?.filter((item) => !item.todayLastLogs[item.todayLastLogs.length - 1].isExist)?.length ===
                        0 && (
                        <S.ManageListItem>
                          <div
                            style={{
