...
const Management = () => {
    ...
    const clubList = [[ "BIND", "CNS", "ALT", "3D", "MODI"],["DUCAMI", "DION", "AND", "COMMAND", "DGSW42"]]
    ...
    return (
        <ModalPortal>
            <S.CheckClassWrapper>
                ...
                {
                     renderModal &&
                    <Modal title={[renderTitle]} onClick={() => {setRenderMemberList([]);setRenderModal(false)}} manage={renderMemberList}></Modal>
                }
            </S.CheckClassWrapper>
        </ModalPortal>
    );
